...
- **Vault Stage 1 — IN FLIGHT (CD-40, D-0058/D-0059), sub-stages 1a+1b+1c
  ...
  HUD Vault field. Remaining CD-40 sub-stage: 1d passkey via WebAuthn PRF
  (verify-first). Auto-lock via the event engine is Stage 2
